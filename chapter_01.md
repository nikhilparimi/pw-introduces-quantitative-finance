...
**Equity** / **Stock** / **Share**: ownership of a small part of the company. Raises capital by selling off future profits in the form of stake in the company.

**Shareholders** own the company between them & have some say in the running of the business.

**3 Stages of a company:**
1. **Private Company:** business is up and running; can raise further capital (for expansion) by issuing new shares (diluting ownership to private investors).
2. **Public Share Offering:** issue new shares to be sold to a wider audience. Wider investor base via public offering to investors such as:
    - Investment funds, pension funds, insurance companies, high net-worth investors and individual retail investors
3. **Stock-Market Listing:** quotation of shares on a regulated stock exchange, where capital can be raised efficiently.<br> **Important note:** The company only receives money when it issues new shares and sells them to investors.
...
- **Primary market:** the company issues new shares and investors buy them (the company receives the capital).
- **Secondary market:** after the shares have been issued, investors trade those shares between themselves (the company generally receives none of this transaction money).

Coin toss to simulate the randomness of a stock price:
- **Multiplicative rule** ($\times 1.01$ or $\times 0.99$): **lognormal** / **geometric** random walk.
- **Additive rule** ($+ 1$ or $- 1$): **normal** / **arithmetic** random walk.



### 1.2.1. Dividends ###

**Dividends:** lump sum payments paid out every quarter or every six months to the holder of the stock (shareholder) usually from profits.

**Key terminology:** 
- **Declaration date:** company announces the dividend.
- **Ex-dividend date (ex-date):** determine who is entitled to the dividend (dependent on if the stock was bought before, on or after the ex-date).
- **Record date:** company determines eligible shareholders. 
- **Payment date:** dividend is paid out to eligible shareholders.
...
- **Buy before ex-date:** generally get the dividend.
- **Buy on / after ex-date:** generally don't get the dividend.
- **Sell before ex-date:** generally keep the dividend entitlement.
